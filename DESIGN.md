...
├── state/
│   ├── current.json        ← 当前最优方案（每轮可能覆盖）
│   ├── discoveries.md      ← 跨文明积累的「已知定律」
│   └── scores.json         ← 每轮分数历史（用于画曲线）
└── logs/
    ├── civilization-001.md
    ├── civilization-002.md
    └── ...
...
{
  "scores": [
    {"n": 1, "total": 42, "delta": null, "perspective": "硅谷风险投资人"},
    {"n": 2, "total": 55, "delta": 13,   "perspective": "NASA工程师"},
    {"n": 3, "total": 61, "delta": 6,    "perspective": "荷兰农业专家"}
  ],
  "best": {"n": 3, "total": 61},
  "trend": "improving"
}
